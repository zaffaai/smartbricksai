  ...
  return (
    <div className="foresight-bg min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 space-y-6">
        ...
        <div className="rounded-2xl border border-blue-500/20 bg-linear-to-r from-blue-600/10 via-blue-500/5 to-transparent p-5 relative">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 mb-2">
                ...
                <MonetizationTooltip content="💰 Behavioral Anchor → Pro Retention | AED 149/mo MRR — Monday habit loop keeps subscribers active and reduces churn by 3×." side="bottom" width="w-72" />
          ...
          {!isPro && (
            <div className="absolute inset-0 flex flex-col items-center justify-center bg-[#0a0e1a]/70 backdrop-blur-sm rounded-2xl">
              <Lock className="w-5 h-5 text-amber-400 mb-2" />
              <p className="text-sm font-bold text-white">Weekly Intelligence Briefing · Pro Feature</p>
              <p className="text-xs text-slate-400 mt-1 text-center max-w-xs">
                Personalised Monday briefing with portfolio performance, zone signals, and 1 recommended action.
              </p>
              <Link
        ...
        <div>
          <div className="flex items-center gap-2 mb-3">
            ...
            <MonetizationTooltip content="💰 Multi-Tier Upgrade Trigger | AED 149/mo MRR + 1.5% deal value — each action card drives Pro upgrades or a transaction referral worth 1.5% of deal size." side="bottom" width="w-72" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="rounded-2xl border border-white/10 bg-white/3 p-5 space-y-4 relative">
            <div className="flex items-center gap-2">
              <Activity className="w-4 h-4 text-amber-400" />
              <h2 className="text-sm font-bold text-white">Portfolio Rebalancing Assistant</h2>
              <MonetizationTooltip content="💰 Pro Retention Driver — 3× Churn Reduction | AED 149/mo MRR — personalised rebalancing creates sticky daily usage that justifies the subscription fee." side="bottom" width="w-72" />
              <span className="ml-auto flex items-center gap-1.5">
                ...
                <span className="text-[10px] font-bold text-amber-400 bg-amber-500/15 border border-amber-500/30 px-1.5 py-0.5 rounded-full flex items-center gap-1">
                  {!isPro && <Lock className="w-2.5 h-2.5" />} PRO
                </span>
              </span>
            </div>

            <div className={cn("space-y-4", !isPro && "blur-sm pointer-events-none select-none")}>
              {/* Concentration bars */}
            ...
            {!isPro && (
              <div className="absolute inset-0 flex flex-col items-center justify-center bg-[#0a0e1a]/70 backdrop-blur-sm rounded-2xl">
                <Lock className="w-5 h-5 text-amber-400 mb-2" />
                <p className="text-sm font-bold text-white">Portfolio Rebalancing · Pro Feature</p>
                <p className="text-xs text-slate-400 mt-1 text-center max-w-xs">
                  AI zone concentration analysis with AED uplift projections and ranked rebalancing actions.
                </p>
                <Link
                  href="/dashboard/foresight/report"
                  className="mt-3 px-4 py-2 bg-amber-500 text-black text-xs font-bold rounded-xl hover:bg-amber-400 transition-colors"
          ...
          <div className="rounded-2xl border border-white/10 bg-white/3 p-5 space-y-4 relative">
            <div className="flex items-center gap-2">
              ...
              <MonetizationTooltip content="💰 Platform Identity → Pro Retention | AED 149/mo MRR — benchmarking against 500+ peers is a defensible data moat that validates the Pro price point." side="bottom" width="w-72" />
              <span className="text-[10px] font-bold text-amber-400 bg-amber-500/15 border border-amber-500/30 px-1.5 py-0.5 rounded-full ml-auto flex items-center gap-1">
                {!isPro && <Lock className="w-2.5 h-2.5" />} PRO
              </span>
            </div>
            ...
            {!isPro && (
              <div className="absolute inset-0 flex flex-col items-center justify-center bg-[#0a0e1a]/70 backdrop-blur-sm rounded-2xl">
                <Lock className="w-5 h-5 text-amber-400 mb-2" />
                <p className="text-sm font-bold text-white">Smart Benchmarking · Pro Feature</p>
                <p className="text-xs text-slate-400 mt-1 text-center max-w-xs">
                  Compare your portfolio against 500+ UAE investors. Your percentile rank, zone-by-zone.
                </p>
                <Link
                  href="/dashboard/foresight/report"
                  className="mt-3 px-4 py-2 bg-amber-500 text-black text-xs font-bold rounded-xl hover:bg-amber-400 transition-colors"
        ...
        <div className="rounded-2xl border border-white/10 bg-white/3 p-5 space-y-4 relative">
          <div className="flex items-center gap-2">
            ...
            <MonetizationTooltip content="💰 Pro Subscription + Transaction Tier Upsell | AED 149/mo + 1.5% deal value — real-time zone alerts convert free users to Pro and surface transaction-ready leads." side="bottom" width="w-72" />
            <span className="text-[10px] font-bold text-amber-400 bg-amber-500/15 border border-amber-500/30 px-1.5 py-0.5 rounded-full ml-auto flex items-center gap-1">
              {!isPro && <Lock className="w-2.5 h-2.5" />} PRO
            </span>
          </div>

          <div className={cn("space-y-2", !isPro && "blur-sm pointer-events-none select-none")}>
          ...
          {!isPro && (
            <div className="absolute inset-0 flex flex-col items-center justify-center bg-[#0a0e1a]/70 backdrop-blur-sm rounded-2xl">
              <Lock className="w-5 h-5 text-amber-400 mb-2" />
              <p className="text-sm font-bold text-white">Zone Signal Radar · Pro Feature</p>
              <p className="text-xs text-slate-400 mt-1 text-center max-w-xs">
                Real-time zone market signals filtered to your holdings and watchlist zones.
              </p>
              <Link
                href="/dashboard/foresight/report"
                className="mt-3 px-4 py-2 bg-amber-500 text-black text-xs font-bold rounded-xl hover:bg-amber-400 transition-colors"
        ...
        <div className="relative">
          <div className="flex items-center gap-2 mb-3">
            ...
            <MonetizationTooltip content="💰 Monthly Re-Engagement → Pro Retention | AED 149/mo MRR — sell-score dials create urgency that keeps investors checking in monthly, sustaining the subscription habit." side="bottom" width="w-72" />
            <span className="text-[10px] font-bold text-amber-400 bg-amber-500/15 border border-amber-500/30 px-1.5 py-0.5 rounded-full ml-auto flex items-center gap-1">
              {!isPro && <Lock className="w-2.5 h-2.5" />} PRO
            </span>
          </div>
          <div className={cn("grid grid-cols-1 md:grid-cols-2 gap-4", !isPro && "blur-sm pointer-events-none select-none")}>
          ...
          {!isPro && (
            <div className="absolute inset-0 flex flex-col items-center justify-center bg-[#0a0e1a]/70 backdrop-blur-sm rounded-2xl mt-10">
              <Lock className="w-5 h-5 text-amber-400 mb-2" />
              <p className="text-sm font-bold text-white">Exit Timing Oracle · Pro Feature</p>
              <p className="text-xs text-slate-400 mt-1 text-center max-w-xs">
                AI sell-score dials with optimal exit window analysis for each property.
              </p>
              <Link
                href="/dashboard/foresight/report"
                className="mt-3 px-4 py-2 bg-amber-500 text-black text-xs font-bold rounded-xl hover:bg-amber-400 transition-colors"
        ...
        <div className="rounded-2xl border border-white/10 bg-white/3 p-5 space-y-4">
          <div className="flex items-center gap-2">
            ...
            <MonetizationTooltip content="💰 Pro Retention → Transaction Pipeline | AED 149/mo + 1.5% deal value — AI-ranked listings turn Pro subscribers into transaction clients worth AED 13K–22K per deal." side="bottom" width="w-72" />
            <span className="text-[10px] font-bold text-amber-400 bg-amber-500/15 border border-amber-500/30 px-1.5 py-0.5 rounded-full ml-auto flex items-center gap-1">
              {!isPro && <Lock className="w-2.5 h-2.5" />} PRO
            </span>
          </div>
