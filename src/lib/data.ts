...
export const ALERT_FEED = [
  ...
  },
  {
    ...
    body: "Total portfolio value: AED 2,690,000. Threshold: AED 2,000,000 — you already qualify based on Taormina alone.",
    time: "5 days ago",
...
export const INTELLIGENCE_CARDS = [
  {
    ...
    cta: "Review offer",
    ctaHref: "/dashboard/property/details/autumn-2-jvc",
    badge: "Price Drop",
    badgeColor: "green",
  },
  {
